...
/* ====================== FAL_FLASHDB_STM32F7 ========================= */
    ...
    * KVDB and TSDB there need at least four sectors. */
    ...
    {                                                                                        \
        {FAL_PART_MAGIC_WORD,  "fdb_kvdb1",    "stm32fx_onchip_flash", 0x00140000, 3*256*1024, 0},  \
    }
...
/* target that link to flashdb library should use target_compile_definitions(flashdb PRIVATE FAL_FLASHDB_STM32F4)
 * to specify the flash device configuration. */
/* ====================== FAL_FLASHDB_STM32F4 ========================= */
#ifdef FAL_FLASHDB_STM32F4
